            ...
            >
              <CardContent className="p-6">
                <p className="text-foreground">
                  Soy Gustavo, mi habilidad principal radica en HTML y CSS,
                  herramientas con las que diseño interfaces claras,
                  estructuradas y fáciles de navegar. Soy un desarrollador
                  frontend especializado en React, JavaScript, Tailwind CSS y
                  Email HTML. Como Vibe Coder, priorizo la velocidad sobre la
                  perfección, usando herramientas modernas para lanzar MVPs
                  funcionales en cuestión de horas y acompañar al equipo en todo
                  el proceso.
                </p>
              </CardContent>
            </Card>
